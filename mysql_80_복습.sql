...
select emp_id, emp_name, dept_id, phone, email, salary, salary*10, salary as bonus
from employee;
...
select emp_id, emp_name, gender, hire_date, retire_date, dept_id, phone, email, ifnull(salary, 0) as salary
from employee
where dept_id = 'stg';
...
select emp_id, emp_name, eng_name, hire_date, salary, ifnull(retire_date, curdate()) as retire_date, dept_id
from employee
where dept_id = 'mkt';
/**************************************
...
select emp_id, emp_name, eng_name, gender, hire_date, retire_date, dept_id phonem, email, salary as '급여'
from employee
where retire_date is not null
order by 급여 desc;
